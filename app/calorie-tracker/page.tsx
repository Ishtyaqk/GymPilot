    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-zinc-900 to-black relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 z-0">
          <div className="w-full h-full bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-emerald-700/30 via-transparent to-transparent opacity-40" />
          <div className="w-full h-full bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-teal-500/20 via-transparent to-transparent opacity-30" />
